...
#=========================================================================
btClear=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),
            text="c",bg="green",command=btnClearDisplay).grid(row=4,column=1)
btnEquals=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),
            text="=",bg="green",command=btnEqualsInput).grid(row=4,column=2)
btn0=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),
            text="0",bg="green",command=lambda:btnClick(0)).grid(row=4,column=0)
